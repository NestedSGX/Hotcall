...
#define DATE "built on: Wed Apr 17 08:32:55 2024 UTC"
...
static const char compiler_flags[] = {
    ...
    'a','c','k',' ','-','W','a','l','l',' ','-','O','3',' ','-','i',
    'n','c','l','u','d','e','/','r','o','o','t','/','o','c','c','l',
    'u','m','_','n','e','w','/','l','i','n','u','x','-','s','g','x',
    '/','e','x','t','e','r','n','a','l','/','s','g','x','s','s','l',
    '/','L','i','n','u','x','/','.','.','/','o','p','e','n','s','s',
    'l','_','s','o','u','r','c','e','/','b','y','p','a','s','s','_',
    't','o','_','s','g','x','s','s','l','.','h',' ','-','D','O','P',
    ...
    'A','S','M',' ','-','D','N','D','E','B','U','G',' ','-','D','_',
    'F','O','R','T','I','F','Y','_','S','O','U','R','C','E','=','2',
    ' ','-','D','G','E','T','P','I','D','_','I','S','_','M','E','A',
    'N','I','N','G','L','E','S','S','\0'
};
