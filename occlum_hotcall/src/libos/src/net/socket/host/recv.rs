...
#[repr(C)]
pub struct occlum_recvmsgParams {
...
extern "C" {
    ...
    pub fn occlum_recvmsg_hotcall(
        data: *mut occlum_recvmsgParams,
    ) -> sgx_status_t;
}
...
impl HostSocket {
    ...
    fn do_recvmsg_untrusted_data(
        ...
        let retval = try_libc!({
            ...
            // hot-calls begin
            let mut data = occlum_recvmsgParams {
                result_p: &mut retval as *mut isize,
                fd: host_fd,
                msg_name: msg_name,
                msg_namelen: msg_namelen as u32,
                msg_namelen_recv: &mut msg_namelen_recvd as *mut u32,
                msg_data: msg_iov,
                msg_datalen: msg_iovlen,
                msg_control: msg_control,
                msg_controllen: msg_controllen,
                msg_controllen_recv: &mut msg_controllen_recvd as *mut usize,
                msg_flags: &mut msg_flags_recvd as *mut i32,
                flags: raw_flags,
            };
            ...
            HotCall_requestCall( hotOcall_p, 7, data_p );
