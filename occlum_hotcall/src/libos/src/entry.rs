...
#[link(kind="static", name="sgx_tprotected_fs")]
extern "C" {
    #[no_mangle]
    static mut p_hotOcall_fs: u64;
}
...
#[no_mangle]
pub extern "C" fn occlum_hotcall_init(addr: u64) {
    /*let p_hotOcall: *mut HotCall = addr as *mut HotCall;
    unsafe {
        hotOcall = p_hotOcall;
    }*/
    unsafe { p_hotOcall = addr; p_hotOcall_fs = addr; }
}
