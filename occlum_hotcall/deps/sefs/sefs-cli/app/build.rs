...
fn main() {
    ...
    // -L$(RUST_SGX_SDK_DIR)/sgx_ustdc/
   // println!("cargo:rustc-link-search=native=../../../rust-sgx-sdk/sgx_ustdc");
    //println!("cargo:rustc-link-lib=dylib=sgx_ustdc");
    ...
    match is_sim.as_ref() {
        "SW" | "SIM" => {
            ...
            //println!("cargo:rustc-link-arg=-lsgx_ustdc");
            //-L$(RUST_SGX_SDK_DIR)/sgx_ustdc/ -lsgx_ustdc
        }
        "HW" => {
