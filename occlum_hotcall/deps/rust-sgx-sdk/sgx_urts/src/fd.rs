...
pub extern "C" fn u_read_ocall(
    ...
    println!("u_read_ocall in rust-sgx-sdk/sgx_urts/src/fd.rs");
    let mut errno = 0;
...
pub extern "C" fn u_pread64_ocall(
    ...
    println!("u_pread64_ocall in rust-sgx-sdk/sgx_urts/src/fd.rs");
    let mut errno = 0;
...
pub extern "C" fn u_readv_ocall(
    ...
    println!("u_readv_ocall in rust-sgx-sdk/sgx_urts/src/fd.rs");
    let mut errno = 0;
...
pub extern "C" fn u_preadv64_ocall(
    ...
    println!("u_preadv64_ocall in rust-sgx-sdk/sgx_urts/src/fd.rs");
    let mut errno = 0;
...
pub extern "C" fn u_write_ocall(
    ...
    println!("u_write_ocall in rust-sgx-sdk/sgx_urts/src/fd.rs");
    let mut errno = 0;
...
pub extern "C" fn u_pwrite64_ocall(
    ...
    println!("u_pwrite64_ocall in rust-sgx-sdk/sgx_urts/src/fd.rs");
    let mut errno = 0;
...
pub extern "C" fn u_writev_ocall(
    ...
    println!("u_writev_ocall in rust-sgx-sdk/sgx_urts/src/fd.rs");
    let mut errno = 0;
...
pub extern "C" fn u_pwritev64_ocall(
    ...
    println!("u_pwritev64_ocall in rust-sgx-sdk/sgx_urts/src/fd.rs");
    let mut errno = 0;
